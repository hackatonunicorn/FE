...
export function CampaignCreate() {
  ...
  const validateStep = (step: number): boolean => {
    ...
    if (step === 1) {
      ...
      if (!campaignData.pitchDeck) newErrors.pitchDeck = 'Pitch deck is required'
    }
            ...
            >
              <Card className="shadow-lg border-0">
                <CardHeader>
                  ...
                  <p className="text-gray-600">Define your funding objectives and timeline</p>
                </CardHeader>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2">
                  <Card className="shadow-lg border-0">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{campaignData.pitchDeck ? campaignData.pitchDeck.name : 'Not uploaded'}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-4">
                        ...
                        <div className="space-y-4">
                          <div>
                            ...
                            <Input
                              value={campaignData.calendlyLink}
                              onChange={(e) => updateCampaignData({ calendlyLink: e.target.value })}
                      ...
                      {/* AI Email Generation Info */}
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div className="flex items-start space-x-3">
                          <Sparkles className="h-6 w-6 text-blue-600 mt-0.5" />
                          <div>
                            <h4 className="font-semibold text-blue-900 mb-2">AI Email Generation</h4>
                            <p className="text-sm text-blue-700 mb-2">
                              Emails will be automatically generated using AI based on each VC's profile, 
                              investment thesis, and your company information.
                            </p>
                            <div className="text-xs text-blue-600">
                              • Personalized subject lines<br/>
                              • Tailored messaging for each investor<br/>
                              • Automatic follow-up sequences<br/>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="text-lg font-bold text-gray-900">Launch Settings</CardTitle>
                    </CardHeader>
